...
It contains two main functions: `pascal_triangle` and
`generate_pascals_triangle_row`. `pascal_triangle` generates a Pascal's
triangle up to a given number of rows. `generate_pascals_triangle_row`
